/**
 * Feed fetch with Cache API (browser storage, not localStorage).
 * Smart cache: dead feeds (>1yr since last post) skip for days, active feeds use
 * a rhythm heuristic (avg interval between posts) to decide when to re-fetch.
 * In-memory fallback when Cache API fails. Concurrency limited to avoid thrashing.
 */
const CACHE_NAME = "video-podcasts-feeds-v2";
const DEAD_FEED_SKIP_DAYS = 3;
const ONE_YEAR_MS = 365 * 24 * 60 * 60 * 1000;
const PROB_DUE_THRESHOLD = 0.65;
const SKIP_STORAGE_KEY = "video_podcasts_skip_v1";
